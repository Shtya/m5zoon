...
export default function Footer() {
    ...
    const contact = [
        { key:"email" , icon : "/imgs/contact-us/1.png" , title : t("contact_uae") , desc : t("email")} ,
        { key:"email" , icon : "/imgs/contact-us/2.png" , title : t("contact_ksa") , desc : t("email")} ,
        { key:"" , icon : "/imgs/contact-us/3.png" , title : t("headquarters") , desc : t("location")} ,
    ]
            ...
            <div className='  relative  p-[50px] min-h-[300px] w-full bg-[#fafbff]  max-md:!p-[30px] max-md:!mx-[0px] rtl:pl-[100px] ltr:pr-[100px] rtl:ml-[100px] ltr:rounded-[0_50px_50px_0] rtl:rounded-[50px_0_0_50px] max-md:!rounded-[0_0_50px_50px] '>
                ...
                <div className='flex max-md:flex-col justify-between gap-[30px] ' >
                    <div className='flex flex-col gap-[10px] ' > 
                        <Image className='' src={"/imgs/logo2.png"} alt='' width={120} height={40} />
                    ...
                    <div>
                        ...
                        <ul className=' social flex items-center gap-[10px] ' >
                            {social.map((e,i)=> <li className=' group cursor-pointer hover:bg-secondery  hover:border-secondery duration-300 w-[40px] h-[40px] bg-white rounded-[5px] border border-[#eeeeee] flex justify-center items-center ' > <a>  {e} </a> </li> )}
                        </ul>
                    </div>
                ...
                <div className='flex max-md:flex-col max-md:items-start max-md:gap-[20px] justify-between items-center mt-[50px] ' >
                    {
                        contact.map((e,i)=> <div className=' flex items-center gap-[15px] ' >
