...
export default function Input({ required , delay , place , dataAos , error , cnInput , cn , label , type , icon , KEY , register , cnLabel}) {
  ...
  const toggleInputType = () => {
	...
	return (
	<div data-aos={dataAos} data-aos-delay={delay} className={`${cn} flex flex-col  gap-[15px]  relative `} >
		...
		<div  className={`h-[60px]  relative overflow-hidden rounded-[8px] text-xl border border-[#7d7d7d]/20 w-full ${cnInput} `} >
