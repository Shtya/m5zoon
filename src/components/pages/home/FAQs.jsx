            ...
            <div className='w-full mt-[50px] grid md:grid-cols-[1fr,320px] items-start gap-[20px] '>
                <ul className=' flex flex-col gap-[20px]'>
                    {t.raw('faqs').map((faq, index) => (
                        <li key={index} className='flex flex-col  px-[10px]  '>
                ...
                <Image className=' h-full max-md:hidden max-w-full w-full object-cover rounded-[8px] ' src={'/imgs/question.png'} alt='' width={400} height={600} />
            </div>
        </div>
    );
}
