...
export default function OurPartners({ title, desc }) {
    ...
    const imgs = ['/imgs/partners/1.png', '/imgs/partners/2.png', '/imgs/partners/3.png', '/imgs/partners/4.png', '/imgs/partners/5.png', '/imgs/partners/6.png', '/imgs/partners/7.png'];
