...
export default function ServicesForExporter({data , t}) {
    	...
    	// "" : {
	// 	"": "خدمات مخزون للمسوقين",
	// 	"": "ارفع مبيعاتك إلى القمة مع خدمات مخزون المميزة المصممة ",
	// 	"": "خصيصًا لكل مسوق.",
        ...
        <div className='py-[80px] bg-white  relative  ' >
			<div className='container w-full h-full'>
                ...
                <div className='flex items-center flex-wrap justify-center gap-[20px] ' >
                    ...
                    {
                        data?.map((e,i)=> (
                            <div key={i} data-aos="zoom-out" data-aos-delay={i+1 + "00"}  className=' max-md:justify-start group duration-300 hover:bg-secondery rounded-[10px] max-md:max-w-[230px] max-md:min-h-[230px] h-full max-w-[300px] min-h-[300px] flex flex-col items-center justify-center p-[20px] w-full ' style={{boxShadow : "0px 10px 60px 0px #262D7614"}} > 
                            {e.icon}
