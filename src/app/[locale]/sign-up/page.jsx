            ...
            <div className='max-md:!w-[100%]  max-md:mx-auto  max-md:!right-[unset] max-md:left-0 absolute h-[100vh]  duration-300 w-[50%] top-0 ltr:left-0  rtl:right-0 z-[1000]   '>
				<div style={{direction : locale == "en" ? "rtl" : "ltr"}} className='max-md:!max-w-full  bg-opacity-[.95] backdrop-blur-2xl bg-white rtl:mr-auto ltr:ml-auto max-w-[1000px] w-full relative max-lg:p-[20px]  p-[50px]  h-[100vh]  overflow-auto ' >
                    ...
                    <div style={{direction : locale == "en" ?  "ltr" :"rtl"}} >
                        ...
                        <form action="" className=' grid grid-cols-2 max-lg:grid-cols-1 gap-x-[20px] gap-y-[40px] max-md:gap-y-[20px]  ' >
                        ...
                        <Checkbox KEY={"terms"} cn={"mt-[40px] max-md:t16 t20 "} setValue={setValue} watch={watch}  label={termsLabel} />

                        <Button name={t("create_account")} cn={"  !max-w-[670px] !w-full mx-auto !my-[40px] hover:bg-opacity-90  bg-secondery "} />

                        <p className=' pb-[30px] text-center text-[#09396f] text-2xl max-md:t18 font-normal'>  {t("already_have_account")} <Link className='text-[#f9a51a]'  href={"/login"} > {t("login")} </Link>  </p>
